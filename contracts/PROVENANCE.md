...
Canonical source: `GithubLarsKomo/skillz/schemas/sport-athlete-management-p2-v1.schema.json`

Imported after Skillz PR #229 was squash-merged as commit `ab5d30828198e6320e3758ffaf2245ff574a4631` and the regular generated-metadata follow-up reached `c84e3d34d460a558f4560e271b6b3022808fe1b6` on 2026-08-22.

The product copies must not be edited independently. Contract updates are imported deliberately from a merged Skillz revision and this provenance note is updated in the same change. P0, P1 and P2 remain separate versioned contracts so specialist/context updates cannot silently change the stable P0 persistence/API boundary.
